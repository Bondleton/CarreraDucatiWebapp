...
export class HomeScreenComponent implements OnInit {
  ...
  public name_user: string = "Itzel Flores";
  ...
  public isMobile(tipo: number): "style-mobile" | "interior-codigos" | "interior-codigos-registrados" | undefined {
    switch (tipo) {
      case 1:
        if (/Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini|Mobile|mobile|CriOS/i.test(navigator.userAgent)) {
          return "style-mobile";
    ...
    // Valor por defecto si el tipo no es ni 1 ni 2
    return undefined;
  }
