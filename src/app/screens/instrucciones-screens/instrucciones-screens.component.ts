...
@Component({
  selector: 'app-instrucciones-screens',
  templateUrl: './instrucciones-screens.component.html',
  styleUrls: ['./instrucciones-screens.component.scss']
})
export class InstruccionesScreensComponent implements OnInit {
